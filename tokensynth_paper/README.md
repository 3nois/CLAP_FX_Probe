...
> 이 폴더는 [KyungsuKim42/tokensynth](https://github.com/KyungsuKim42/tokensynth)의 미러입니다.
> 이 저장소가 실제로 진행 중인 실험(**CLAP FX Probe**)은 상위 폴더의
> [`../README.md`](../README.md)를 참고하세요. `PAPER_SUMMARY.md`는 TokenSynth
> 논문(ICASSP 2025) 요약입니다.
...
You can also run `python quickstart.py` from this directory.
